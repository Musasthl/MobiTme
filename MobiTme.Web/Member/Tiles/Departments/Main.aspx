<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="MobiTme.Member.Tiles.Departments.Main" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ListDataTable(parameters) {
            $.ajax({
                type: "Post",
                url: window.location.pathname + "/ListDepartments",
        ...
        function insert() {
            ...
            department.DepartmentID = $('#HiddenFieldKey').val();
            department.SiteID = SITE_ID;
            department.DepartmentName = $("#tbDepartment").val();
            department.PayrollCode = $("#tbPayrollCode").val();
            department.AccountsCode = $("#tbAccountsCode").val();
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="layout_center">
            <div class="pageTitle">Department Masterfile</div>
            <div id="detailContent">
                <div id="divDetail1" class="divDetail">
                    ...
                    <table class="striped" style="margin-top: 30px;">
                        <thead>
                            <tr>
                                <td class="hidden">DepartmentID</td>
