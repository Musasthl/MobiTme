<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayAdjustments.aspx.cs" Inherits="UITemplate.Member.Tiles.PayRules.Iframes.PayAdjustments" %>
...
<head runat="server">
    ...
    <script src="../../../../Scripts/metro_ui_css/javascript/contextmenu.js"></script>
    ...
    <script src="../Scripts/iframes-main.js"></script>
</head>
<body class="metrouicss iframe-page" >
