<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="MobiTme.Web.Member.Tiles.ShiftPatterns.Main" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#tbShiftPatternStarts').datepicker();
        ...
        function ListDataTable(parameters) {
            $.ajax({
                type: "Post",
                url: window.location.pathname + "/ListShiftPatterns",
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (jsonData != null) {
                        ...
                        $("#tbShiftPatternStarts ").val(row.ShiftPatternStarts);
                        $("#tbOvertimeCycleStarts").val(row.OvertimeCycleStarts);
                        $("#tbOvertimeCycleDays").val(row.OvertimeCycleDays);
        ...
        function insert() {
            var shiftPattern = new Object();
            shiftPattern.ShiftPatternID = $('#HiddenFieldKey').val();
            shiftPattern.SiteID = SITE_ID;
            shiftPattern.ShiftPatternName = $("#tbShiftPattern").val();
            shiftPattern.ShiftPatternStarts = $("#tbShiftPatternStarts ").val();
            shiftPattern.OvertimeCycleStarts = $("#tbOvertimeCycleStarts").val();
            shiftPattern.OvertimeCycleDays = $("#tbOvertimeCycleDays").val();
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: "json", // can be used for plaintext or for JSON
                data: JSON.stringify({ shiftPattern: shiftPattern }),
                success: function (response) {
                    var data = response.d;
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="layout_center">
            <div class="pageTitle">Shift Pattern Masterfile</div>
            <div id="detailContent">
                    ...
                    <table class="striped" style="margin-top: 30px;">
                        <thead>
                            <tr>
                                ...
                                <td class="hidden">ShiftPatternID</td>
                                <td>Shift Pattern</td>
                                <td>Shift Pattern Starts</td>
                                <td>Overtime Cycle Starts</td>
                                <td>Over timeCycle Days</td>
                            </tr>
                        </thead>
                ...
                <div id="divDetail2" class="divDetail">
                    ...
                    <div style="padding-left: 10px;">
                        ...
                        <div style="width: 300px; float: left;">
                            <input id="tbShiftPattern" style="width: 300px" type="text">
                        </div>
                        <br>
                        <br>

                        <div style="width: 120px; float: left; padding-top: 5px">Starts on</div>
                        <div style="width: 20px; float: left; padding-top: 5px">:</div>
                        <div style="width: 300px; float: left;">
                            <input id="tbShiftPatternStarts" style="width: 150px" type="text">
                        </div>
                        <br>
                        <br>
                    </div>
                ...
                <div id="divDetail3" class="divDetail">
                    <div>
                        <h1>Shift Pattern Schedule</h1>
                    </div>
                    <div style="padding-left: 10px;">
                        <div>{ADD SHIFT PATTERN SCHEDULE DIV HERE}</div>
                    </div>
                </div>
                <div id="divDetail4" class="divDetail">
                    <div>
                        <h1>Overtime Cycle Detail</h1>
                    </div>
                    <div style="padding-left: 10px;">
                        <div style="width: 120px; float: left; padding-top: 5px">Starts on</div>
                        <div style="width: 20px; float: left; padding-top: 5px">:</div>
                        <div style="width: 300px; float: left;">
                            <input id="tbOvertimeCycleStarts" style="width: 150px" type="text">
                        </div>
                        <br>
                        <br>
                        <div style="width: 120px; float: left; padding-top: 5px">Repeats (Days)</div>
                        <div style="width: 20px; float: left; padding-top: 5px">:</div>
                        <div style="width: 300px; float: left;">
                            <input id="tbOvertimeCycleDays" style="width: 50px" type="text">
                        </div>
                        <br>
                        <br>
                    </div>
                ...
                <div id="divDetail5" class="divDetail">
                    <div>
                        <h1>Overtime Adjustment Detail</h1>
                    </div>
                    <div style="padding-left: 10px;">
                        <div>{ADD PAY ADJUSTMENTS DIV HERE}</div>
                    </div>
                </div>
