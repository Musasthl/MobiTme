<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="MobiTme.Member.Tiles.CostCenters.Main" %>
...
***/
    ...
    <script type="text/javascript">
        ...
        function ListDataTable(parameters) {
            $.ajax({
                type: "Post",
                url: window.location.pathname + "/ListCostCentres",
        ...
        function insert() {
            ...
            costCenter.CostCentreID = $('#HiddenFieldKey').val();
            costCenter.SiteID = SITE_ID;
            costCenter.CostCentre = $("#tbCostCentre").val();
            costCenter.PayrollCode = $("#tbPayrollCode").val();
            costCenter.AccountsCode = $("#tbAccountsCode").val();
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="layout_center">
            <div class="pageTitle">Cost Centre Masterfile</div>
            <div id="detailContent">
                <div id="divDetail1" class="divDetail">
                    ...
                    <table class="striped" style="margin-top: 30px;">
                        <thead>
                            <tr>
                                <td class="hidden">Cost CentreID</td>
                ...
                <div id="divDetail2" class="divDetail">
                    ...
                    <div style="padding-left: 10px;">
                        ...
                        <div style="width: 300px; float: left;">
                            <input id="tbCostCentre" style="width: 300px" type="text">
                        </div>
                        <br>
                        <br>
