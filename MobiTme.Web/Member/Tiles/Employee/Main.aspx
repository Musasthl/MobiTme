            ...
            <div id="detailContent">
                ...
                <div id="divDetail2" class="divDetail">
                    ...
                    <div style="padding-left: 10px;">
                     ...
                     <select id="tbTitle" style="width: 300px">
                ...
                <div id="divDetail4" class="divDetail">
                    ...
                    <div style="padding-left: 10px;">
                        ...
                        <div style="width: 300px; float: left;">
                             ...
                             <select id="tbCountry_Physical" style="width: 300px">
                                <option value="4">Afghanistan</option>
                                <option value="248">Åland Islands</option>
                                <option value="8">Albania</option>
                                <option value="12">Algeria</option>
                        ...
                        <div style="width: 300px; float: left;">
                             ...
                             <select id="tbCountry_Postal" style="width: 300px">
                                <option value="4">Afghanistan</option>
                                <option value="248">Åland Islands</option>
                                <option value="8">Albania</option>
                                <option value="12">Algeria</option>
                        ...
                        <div style="width: 300px; float: left;">
                             ...
                             <select id="tbCountry_Residential" style="width: 300px">
                                <option value="4">Afghanistan</option>
                                <option value="248">Åland Islands</option>
                                <option value="8">Albania</option>
                                <option value="12">Algeria</option>
